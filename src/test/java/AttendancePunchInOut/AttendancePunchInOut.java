...
public class AttendancePunchInOut {
    WebDriver browser;
    ...
    void inOut() {
        ...
        wait(1000);
        browser.findElement(By.id("menu_attendance_Attendance")).click();
        wait(2000);
        browser.findElement(By.id("menu_attendance_punchIn")).click();
        wait(2000);
        browser.findElement(By.className("punchInbutton")).click();
        wait(3000);
        browser.findElement(By.className("punchOutbutton")).click();
        wait(1000);
    }
